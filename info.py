...
if len(FILES_DATABASE_URL) == 0:
    ...
    exit()
SECOND_FILES_DATABASE_URL = environ.get('SECOND_FILES_DATABASE_URL', "mongodb+srv://raayi:raayi87@@raani.pqqj1.mongodb.net/?retryWrites=true&w=majority&appName=raani")
