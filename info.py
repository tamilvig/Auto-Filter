...
if len(FILES_DATABASE_URL) == 0:
    ...
    exit()
SECOND_FILES_DATABASE_URL = environ.get('SECOND_FILES_DATABASE_URL', "mongodb+srv://Momo:tnmomo@naruto.khppj.mongodb.net/?retryWrites=true&w=majority&appName=naruto")
